$( document ).ready(function() {
	...
	d3.csv("data/articles-122591.csv", function(csv_data){
		...
		var nested_data = d3.nest()
			...
			.key(function(d)  { return d.SubtÌtulo; })
			.key(function(d)  { return d.DenominaciÛn; })
			.entries(csv_data);
		...
		root = reSortRoot(root,"Monto Pesos");
